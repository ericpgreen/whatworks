...
In this session we will explore data from the [Gapminder website](http://www.gapminder.org/).
...
In this session we will explore data from the [Global Burden of Disease studies](http://www.healthdata.org/).
...
Each group will have 5 minutes to present. Your peer review of group presentations is due by 5pm on Oct 27.